module github.com/it234/gowebssh

go 1.12

replace (
	cloud.google.com/go => github.com/GoogleCloudPlatform/google-cloud-go v0.38.0
	github.com/it234/gowebssh/internal => ./internal
	github.com/it234/gowebssh/pkg => ./pkg
...
require (
	github.com/it234/gowebssh/internal v0.0.0-00010101000000-000000000000
	github.com/it234/gowebssh/pkg v0.0.0-00010101000000-000000000000 // indirect
)
